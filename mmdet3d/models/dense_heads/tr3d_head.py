...
from mmdet3d.core.visualizer.show_result import _write_obj, _write_oriented_bbox_v2, show_result_v2
...
def varifocal_loss_with_logits(pred_logits,
    ...
    loss = F.binary_cross_entropy_with_logits(
        pred_logits, gt_score.float(), weight=weight, reduction='none')
    return loss
...
class TR3DAssigner200:
    def __init__(self, top_pts_threshold, label2level, assign_type='volume', volume_threshold=27, voxel_size=0.01):
