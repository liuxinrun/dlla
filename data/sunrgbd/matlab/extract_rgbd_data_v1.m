...
load('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBDtoolbox/Metadata/SUNRGBDMeta.mat')
% load('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBDtoolbox/Metadata/SUNRGBD2Dseg.mat')

%% Create folders
det_label_folder = '/data/lxr/dataset/SUNRGBD/sunrgbd_trainval/label_v1/';
...
data.depthpath(1:16) = '';
data.depthpath = strcat('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBD', data.depthpath);
data.rgbpath(1:16) = '';
data.rgbpath = strcat('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBD', data.rgbpath);
