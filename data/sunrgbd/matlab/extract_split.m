...
addpath('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBDtoolbox')

%% Construct Hash Map
hash_train = java.util.Hashtable;
hash_val = java.util.Hashtable;

split = load('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBDtoolbox/traintestSUNRGBD/allsplit.mat');
...
if exist('/data/lxr/dataset/SUNRGBD/sunrgbd_trainval','dir')==0
    mkdir('/data/lxr/dataset/SUNRGBD/sunrgbd_trainval');
end
fid_train = fopen('/data/lxr/dataset/SUNRGBD/sunrgbd_trainval/train_data_idx.txt', 'w');
fid_val = fopen('/data/lxr/dataset/SUNRGBD/sunrgbd_trainval/val_data_idx.txt', 'w');
