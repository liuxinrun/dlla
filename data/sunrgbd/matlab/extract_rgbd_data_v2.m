...
clear; close all; clc;
addpath(genpath('.'))
addpath('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBDtoolbox/readData')
...
load('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBDMeta3DBB_v2.mat');
load('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD/SUNRGBDMeta2DBB_v2.mat');
%% Create folders
depth_folder = '/data/lxr/dataset/SUNRGBD/sunrgbd_trainval/depth/';
image_folder = '/data/lxr/dataset/SUNRGBD/sunrgbd_trainval/image/';
calib_folder = '/data/lxr/dataset/SUNRGBD/sunrgbd_trainval/calib/';
det_label_folder = '/data/lxr/dataset/SUNRGBD/sunrgbd_trainval/label/';
seg_label_folder = '/data/lxr/dataset/SUNRGBD/sunrgbd_trainval/seg_label/';
mkdir(depth_folder);
mkdir(image_folder);
mkdir(calib_folder);
...
data.depthpath(1:16) = '';
data.depthpath = strcat('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD', data.depthpath);
data.rgbpath(1:16) = '';
data.rgbpath = strcat('/data/lxr/dataset/SUNRGBD/OFFICIAL_SUNRGBD', data.rgbpath);
