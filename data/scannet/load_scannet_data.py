...
def export(mesh_file,
    ...
    label_map = scannet_utils.read_label_mapping(
        label_map_file, label_from='raw_category', label_to=label_to)
...
def main():
    ...
    parser.add_argument('--label_to', default="nyu40id", help='label map type')
    parser.add_argument(
        '--label_map_file',
        required=True,
    ...
    export(mesh_file, agg_file, seg_file, meta_file, opt.label_map_file, opt.label_to, 
           opt.output_file)
