...
class ScanNetData(object):
    ...
    def __init__(self, root_path, split='train', scannet200=False):
        ...
        def process_single_scene(sample_idx):
            ...
            if has_label:
                ...
                if annotations['gt_num'] != 0:
                    ...
                    # print("classes:",classes, "self.cat_ids2class:", self.cat_ids2class)
                    annotations['name'] = np.array([
                        self.label2cat[self.cat_ids2class[int(classes[i])]]
