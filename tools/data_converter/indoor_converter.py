...
def create_indoor_info_file(data_path,
    ...
    assert pkl_prefix in ['sunrgbd', 'scannet', 'scannet200', 's3dis'], \
    ...
    if pkl_prefix in ['sunrgbd', 'scannet', 'scannet200']:
        ...
        if pkl_prefix == 'sunrgbd':
            ...
            scannet200 = pkl_prefix in ['scannet200']
            train_dataset = ScanNetData(root_path=data_path, split='train', scannet200=scannet200)
            val_dataset = ScanNetData(root_path=data_path, split='val', scannet200=scannet200)
            test_dataset = ScanNetData(root_path=data_path, split='test', scannet200=scannet200)
